...
import { ArrowLeft, X, Check, MapPin, Calendar, Clock, CreditCard, AlertCircle } from 'lucide-react'
...
export default function PipeRemovalPage() {
  ...
  const canProceed = () => {
    switch (currentStep) {
      case 1: return selected !== null && extra.trim() !== ''
  ...
  const stepTitles = ['배관 정보', '방문 일정', '결제 방법', '신청 확인']
      ...
      <main className="page-content pb-28">
          ...
          <div className="animate-fade-in-scale" style={{ animationDuration: '300ms' }}>
            ...
            <div className="bg-white px-5 py-5">
              ...
              <textarea
                ...
                placeholder="배관 작업에 대한 요청사항을 상세히 입력해주세요"
                value={extra}
        ...
        {currentStep === 4 && (
          <div className="animate-fade-in-scale" style={{ animationDuration: '300ms' }}>
            ...
            {/* 서비스 정보 */}
            <div className="bg-white px-5 py-5">
              <p className="text-[13px] font-medium text-[#8E8E93] tracking-[-0.2px] mb-3">가스 종류</p>
              ...
              {extra.trim() && (
                <div className="mt-3 pt-3 border-t border-[#F0F0F2]">
                  <p className="text-[13px] text-[#8E8E93] mb-1">요청사항</p>
