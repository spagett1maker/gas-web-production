...
import { ArrowLeft, X, Check, MapPin, Calendar, Clock, CreditCard, Info } from 'lucide-react'
...
export default function GasInspectionPage() {
  ...
  const stepTitles = ['요청사항', '방문 일정', '결제 방법', '신청 확인']
      ...
      <main className="page-content pb-28">
        ...
        {currentStep === 1 && (
          <div className="animate-fade-in-scale" style={{ animationDuration: '300ms' }}>
            ...
            <div className="bg-white px-5 py-4">
              <div className="flex items-center gap-3 p-4 bg-[#FEF2EE] rounded-xl">
                <Info className="w-5 h-5 text-[#EB5B37] flex-shrink-0" strokeWidth={2} />
                <p className="text-[14px] font-medium text-[#EB5B37] tracking-[-0.2px]">
            ...
            <div className="bg-white px-5 py-5">
              <div className="flex items-center gap-1.5 mb-3">
                <p className="text-[13px] font-medium text-[#8E8E93] tracking-[-0.2px]">요청사항</p>
                <span className="text-[11px] font-semibold text-[#EB5B37] bg-[#FEF2EE] px-1.5 py-0.5 rounded">필수</span>
              </div>
              <textarea
                className="w-full min-h-[120px] bg-[#F5F5F7] rounded-xl px-4 py-3.5 text-[15px] text-[#1A1A1A] tracking-[-0.2px] resize-none focus:outline-none focus:ring-1 focus:ring-[#EB5B37] placeholder:text-[#C7C7CC]"
                placeholder="가스누출 검사에 대한 요청사항을 상세히 입력해주세요"
                value={extra}
        ...
        {currentStep === 4 && (
          <div className="animate-fade-in-scale" style={{ animationDuration: '300ms' }}>
            ...
            {/* 요청사항 */}
            <div className="bg-white px-5 py-5">
              <p className="text-[13px] font-medium text-[#8E8E93] tracking-[-0.2px] mb-3">요청사항</p>
